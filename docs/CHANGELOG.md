...
### 71. [UI/UX] Category Budgets Refinements, Spacing & Alignment Polish (v5.225l)
...
- **PWA Assets & SW Cache Updates**: Bumped the Service Worker cache schema to version `v114` to force automatic client-side updates, and updated the application metadata version in `index.html` to `v5.225l`.
