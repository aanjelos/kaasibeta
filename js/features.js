    ...
    if (filteredTransactions.length === 0) {
      ...
      filteredTransactions.forEach((t, index) => {
        ...
        if (t.paidOff) {
          ...
          bigAmountText = `<span class="font-semibold text-base tabular-nums"><span class="text-expense">${formatCurrency(remainingOnItem)}</span> <span class="text-gray-500 text-sm">of ${formatCurrency(t.amount)} Left</span></span>`;
        } else {
